          ...
          <div className="p-8">
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center">
                <span className="bg-white/80 dark:bg-gray-900/80 px-3 text-xs font-medium uppercase tracking-wide text-gray-500">or {mode === 'signin' ? 'sign in' : 'register'} with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleCredentialsSubmit} className="space-y-4">
              {mode === 'register' && (
                <div>
                  ...
                  <input value={name} onChange={e => setName(e.target.value)} placeholder="Your name" className="w-full rounded-lg border border-gray-300/70 dark:border-gray-600 bg-white/60 dark:bg-gray-800/60 px-3 py-2 text-sm focus:outline-none focus:ring-2 ring-accentTeal/40" />
                </div>
              )}
              <div>
                <label className="block text-xs font-medium text-gray-600 mb-1">Email</label>
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} required placeholder="you@example.com" className="w-full rounded-lg border border-gray-300/70 dark:border-gray-600 bg-white/60 dark:bg-gray-800/60 px-3 py-2 text-sm focus:outline-none focus:ring-2 ring-accentTeal/40" />
              </div>
              <div>
                <label className="block text-xs font-medium text-gray-600 mb-1">Password</label>
                <input type="password" value={password} onChange={e => setPassword(e.target.value)} required placeholder="••••••••" className="w-full rounded-lg border border-gray-300/70 dark:border-gray-600 bg-white/60 dark:bg-gray-800/60 px-3 py-2 text-sm focus:outline-none focus:ring-2 ring-accentTeal/40" />
              </div>
